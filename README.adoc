...
=== Version 3.0.1
* Fixed Issues regarding the installation directory of jQAssistant
...
Add in your Gradle project in question the plugin via
    ...
    plugins {
        id "de.kontext-e.jqassistant.gradle" version "3.0.1"
    }
...
or
    ...
    buildscript {
        ...
        dependencies {
            classpath 'de.kontext-e.jqassistant.gradle:jqassistant-gradle-plugin:3.0.1'
        }
    }
...
For a more detailed explanation see the example project.
